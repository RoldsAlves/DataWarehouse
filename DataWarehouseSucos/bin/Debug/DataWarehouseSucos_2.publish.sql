...
GO
PRINT N'Rename refactoring operation with key 9c36aa19-7421-4b9b-a1db-8998d87b35e7 is skipped, element [dbo].[Dim_Categoria].[Id] (SqlSimpleColumn) will not be renamed to Cod_Categoria';


GO
PRINT N'Rename refactoring operation with key 00b53f92-f469-4305-8175-6d9f25ee1cf9 is skipped, element [dbo].[Dim_Marca].[Id] (SqlSimpleColumn) will not be renamed to Cod_Marca';


GO
PRINT N'Rename refactoring operation with key 97a0dee9-58c3-4f5f-905a-288e06c0502e is skipped, element [dbo].[Dim_Produto].[Id] (SqlSimpleColumn) will not be renamed to Cod_Produto';
