...
GO
PRINT N'Rename refactoring operation with key 1cf266ac-9848-4e1f-a98a-a572a3c753ae is skipped, element [dbo].[Fato_002].[Faturamento] (SqlSimpleColumn) will not be renamed to Frete';


GO
PRINT N'Rename refactoring operation with key bd1904e3-2b6e-4922-9428-520eae2c14a2 is skipped, element [dbo].[Fato_003].[Frete] (SqlSimpleColumn) will not be renamed to Custo_Fixo';


GO
PRINT N'Rename refactoring operation with key c2bb5ccd-f656-4e61-a57b-f5a29c8c3e6a is skipped, element [dbo].[Fato_004].[Faturamento] (SqlSimpleColumn) will not be renamed to Meta_Faturamento';
